...
export const DEFAULT_EDITOR_MANAGER_STATE: SnapshotIn<typeof EditorManager> = {
  messages: [
    {
      content:
        "Hey, welcome to <:discohook:736648398081622016> QuarrelPost! The easiest way to build and send Discord messages with embeds using webhooks.\n\nThe embeds below explain a bit more, but you're not required to read them. If you're ready, click on the \"Clear All\" button in the editor to start making your own messages.\n\nQuarrelPost has [a support server](https://discohook.app/discord)! Feel free to join and ask any questions you may have, or suggest things you'd like to see.\n\nThere's also [a complementary bot](https://discohook.app/bot), it's completely optional but you may want it.\n_ _",
      embeds: [
        {
          title: "What's this?",
          description:
            'QuarrelPost is a free tool that sends messages with embeds to your Discord server. To do that it uses [webhooks](https://support.discord.com/hc/en-us/articles/228383668), a Discord feature that lets any application send messages to a channel.\n\nTo send messages, you need a webhook URL, you can get one via the "Integrations" tab in your server\'s settings.\n\nNote that QuarrelPost cannot respond to user interactions, it only sends messages when you tell it to. As such creating an automatic feed or custom commands is not possible with QuarrelPost.',
          color: {
        ...
        },
        {
          title: "Discord bot",
          description:
            "QuarrelPost has a complementary bot, while it's not strictly required to send messages it may be helpful to have it.\n\nBelow is a small but incomplete overview of what the bot can do for you.",
          color: {
            hue: 205.14970059880238,
            saturation: 0.6549019607843137,
            value: 1,
